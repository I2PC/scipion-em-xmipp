...
from xmipp3.protocols.protocol_apply_deformation_pdb import XmippProtPDBApplySPH


class XmippProtPDBApplyViewer(pwviewer.ProtocolViewer):
    """ Visualize the deformation applied to the PDB file """
    _label = 'pdb - apply deformation sph'
    _targets = [XmippProtPDBApplySPH]
