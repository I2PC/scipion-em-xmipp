...
from xmipp3.protocols.protocol_structure_map_pdb import XmippProtStructureMapPDB


class XmippProtStructureMapPDBViewer(ProtocolViewer):
    """ Wrapper to visualize different type of data objects
    with the Xmipp program xmipp_showj
    """
    
    _label = 'viewer structure map pdb'
    _environments = [DESKTOP_TKINTER, WEB_DJANGO]
    _targets = [XmippProtStructureMapPDB]
    ...
    def _defineParams(self, form):
        ...
        form.addParam('map', params.EnumParam, choices=['Deformation'],
    ...
    def _visualize(self, e=None):
        ...
        count = 0
        labels = []
        _, idList = self.protocol._iterInputStructures(self.protocol.inputPDBs, [], [])
