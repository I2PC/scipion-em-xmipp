...
class XmippProtReconstructHighRes(ProtRefine3D, HelicalFinder):
    ...
    def _defineParams(self, form):
        ...
        form.addParam('nextResolutionCriterion', FloatParam,
                      label="FSC criterion", default=0.5,
                      expertLevel=LEVEL_ADVANCED,
        ...
        form.addParam('nextDropout', FloatParam, label="Dropout", default=0.0,
                      expertLevel=LEVEL_ADVANCED,
                      help='This is the probability with which voxels are dropped (set to 0.0) inside the binary mask')
        form.addParam('nextReferenceScript', StringParam,
                      label="Next reference command", default="",
                      expertLevel=LEVEL_ADVANCED,
        ...
        form.addParam('nextRemove', BooleanParam,
                      label="Remove reference to save space?", default=True,
                      expertLevel=LEVEL_ADVANCED,
                      help='Remove reference volumes once they are not needed any more.')

        form.addSection(label='Angular assignment')
        form.addHidden('splitMethod', EnumParam, label='Image split method',
                       choices=['Stochastic', 'Fixed'],
                       default=self.SPLIT_FIXED,
                       expertLevel=LEVEL_ADVANCED)
        form.addParam('multiresolution', BooleanParam,
                      label='Multiresolution approach', default=True,
                      expertLevel=LEVEL_ADVANCED,
        ...
        form.addParam('numberOfIterations', IntParam, default=3,
                      ...
                      condition='alignmentMethod!=2')
        form.addParam('NimgsSGD', IntParam, default=250,
                      label='Random subset size',
                      condition='alignmentMethod==3',
                      expertLevel=LEVEL_ADVANCED,
                      help="Stochastic alignment is performed by taking random subsets of images of this size")
        form.addParam('alphaSGD', FloatParam, default=0.1, label='Step size',
                      condition='alignmentMethod==3',
                      expertLevel=LEVEL_ADVANCED,
                      help="The update is performed as V(k+1)=(1-alpha)*V(k)+alpha*R(k+1), that is, the previous "
                           "volume weights 1-alpha, while the new one weights alpha")
        form.addParam("restrictReconstructionAngles", BooleanParam,
                      label="Restrict reconstruction angles", default=False,
                      expertLevel=LEVEL_ADVANCED,
        ...
        line = form.addLine('Tilt angle restriction:',
                            help='0 degrees represent top views, 90 degrees represent side views',
                            condition="restrictReconstructionAngles")
        line.addParam('angularMinTiltReconstruct', FloatParam, label="Min.",
                      default=88, condition="restrictReconstructionAngles",
                      help="Perform an angular assignment and only use those images whose angles are within these limits")
        line.addParam('angularMaxTiltReconstruct', FloatParam, label="Max.",
        ...
        form.addParam('numberOfPerturbations', IntParam,
                      label="Number of Perturbations", default=1,
                      condition='alignmentMethod!=1',
                      expertLevel=LEVEL_ADVANCED,
                      help="The gallery of reprojections is randomly perturbed this number of times")
        ...
        form.addParam('contShift', BooleanParam, label="Optimize shifts?",
                      default=True, condition='alignmentMethod==1',
                      help='Optimize shifts within a limit')
        form.addParam('contMaxShiftVariation', FloatParam,
                      label="Max. shift variation", default=2,
                      condition='alignmentMethod==1',
                      expertLevel=LEVEL_ADVANCED,
                      help="Percentage of the image size")
        form.addParam('contScale', BooleanParam, label="Optimize scale?",
                      default=False, condition='alignmentMethod==1',
                      help='Optimize scale within a limit')
        form.addParam('contMaxScale', FloatParam, label="Max. scale variation",
                      default=0.02, condition='alignmentMethod==1',
                      expertLevel=LEVEL_ADVANCED)
        form.addParam('contAngles', BooleanParam, label="Optimize angles?",
                      default=True, condition='alignmentMethod==1',
                      help='Optimize angles within a limit')
        form.addParam('contGrayValues', BooleanParam,
                      label="Optimize gray values?", default=False,
                      condition='alignmentMethod==1',
        ...
        form.addParam('contMaxGrayScale', FloatParam,
                      label="Max. gray scale variation", default=0.5,
                      condition='alignmentMethod==1',
                      expertLevel=LEVEL_ADVANCED)
        form.addParam('contMaxGrayShift', FloatParam,
                      label="Max. gray shift variation", default=3,
                      condition='alignmentMethod==1',
                      expertLevel=LEVEL_ADVANCED,
                      help='As a factor of the image standard deviation')
        form.addParam('contDefocus', BooleanParam, label="Optimize defocus?",
                      condition='alignmentMethod==1', default=False)
        form.addParam('contMaxDefocus', FloatParam,
                      label="Max. defocus variation", default=200,
                      condition='alignmentMethod==1',
                      expertLevel=LEVEL_ADVANCED,
                      help="In Angstroms")
        form.addParam('contPadding', IntParam, label="Fourier padding factor",
                      default=2, condition='alignmentMethod==1',
                      expertLevel=LEVEL_ADVANCED,
                      help='The volume is zero padded by this factor to produce projections')
        form.addParam('contSimultaneous', IntParam,
                      label="Number of simultaneous processes", default=4,
                      condition='alignmentMethod==1',
                      expertLevel=LEVEL_ADVANCED,
        ...
        form.addParam('weightSSNR', BooleanParam, label="Weight by SSNR?",
                      default=False, expertLevel=LEVEL_ADVANCED,
                      help='Weight input images by SSNR')
        form.addParam('weightContinuous', BooleanParam,
                      label="Weight by Continuous cost?", default=False,
                      expertLevel=LEVEL_ADVANCED,
                      condition='alignmentMethod==1',
                      help='Weight input images by angular assignment cost')
        form.addParam('weightJumper', BooleanParam,
                      label="Weight by angular stability?", default=False,
                      expertLevel=LEVEL_ADVANCED,
                      help='Weight input images by angular stability between iterations')
        form.addParam('weightCC', BooleanParam,
                      label="Weight by CC percentile?", default=True,
                      expertLevel=LEVEL_ADVANCED,
                      help='Weight input images by their fitness (cross correlation) percentile in their defocus group')
        form.addParam('weightCCmin', FloatParam, label="Minimum CC weight",
                      default=0.1, expertLevel=LEVEL_ADVANCED,
                      help='Weights are between this value and 1')

        form.addSection(label='Post-processing')
        form.addParam('postAdHocMask', PointerParam, label="Mask",
                      pointerClass='VolumeMask', allowsNull=True,
                      help='The mask values must be between 0 (remove these pixels) and 1 (let them pass). Smooth masks are recommended.')
        groupSymmetry = form.addGroup('Symmetry', expertLevel=LEVEL_ADVANCED)
        groupSymmetry.addParam('postSymmetryWithinMask', BooleanParam,
                               label="Symmetrize volume within mask?",
                               default=False)
        ...
        groupSymmetry.addParam('postSymmetryWithinMaskMask', PointerParam,
                               ...
                               condition="postSymmetryWithinMask",
                               help='The mask values must be between 0 (remove these pixels) and 1 (let them pass). Smooth masks are recommended.')
        groupSymmetry.addParam('postSymmetryHelical', BooleanParam,
                               label="Apply helical symmetry?", default=False)
        groupSymmetry.addParam('postSymmetryHelicalRadius', IntParam,
                               label="Radius", default=-1,
                               condition='postSymmetryHelical',
                               help="In Angstroms")
        groupSymmetry.addParam('postSymmetryHelicalDihedral', BooleanParam,
                               label="Dihedral symmetry", default=False,
                               condition='postSymmetryHelical')
        groupSymmetry.addParam('postSymmetryHelicalMinRot', FloatParam,
                               label="Min. Rotation", default=0,
                               condition='postSymmetryHelical',
                               help="In degrees")
        groupSymmetry.addParam('postSymmetryHelicalMaxRot', FloatParam,
                               label="Max. Rotation", default=360,
                               condition='postSymmetryHelical',
                               help="In degrees")
        groupSymmetry.addParam('postSymmetryHelicalMinZ', FloatParam,
                               label="Min. Z shift", default=0,
                               condition='postSymmetryHelical',
                               help="In angstroms")
        groupSymmetry.addParam('postSymmetryHelicalMaxZ', FloatParam,
                               label="Max. Z shift", default=40,
                               condition='postSymmetryHelical',
                               help="In angstroms")
        form.addParam('postScript', StringParam,
                      label="Post-processing command", default="",
                      expertLevel=LEVEL_ADVANCED,
                      help='A command template that is used to post-process the reconstruction. The following variables can be used '
                           ...
                           'xmipp_transform_filter -i %(volume)s --fourier low_pass 15 --sampling %(sampling)s\n'
                           '/home/joe/myScript %(volume)s sampling=%(sampling)s dim=%(dim)s')
        form.addParam('postSignificantDenoise', BooleanParam,
                      label="Significant denoising Real space",
                      expertLevel=LEVEL_ADVANCED, default=True)
        form.addParam('postFilterBank', BooleanParam,
                      label="Significant denoising Fourier space",
                      expertLevel=LEVEL_ADVANCED, default=True)
        form.addParam('postLaplacian', BooleanParam,
                      label="Laplacian denoising", expertLevel=LEVEL_ADVANCED,
                      default=True,
                      help="It can only be used if there is a mask")
        form.addParam('postDeconvolve', BooleanParam,
                      label="Blind deconvolution", expertLevel=LEVEL_ADVANCED,
                      default=True)
        form.addParam('postSoftNeg', BooleanParam,
                      label="Attenuate undershooting",
                      expertLevel=LEVEL_ADVANCED, default=True)
        form.addParam('postSoftNegK', FloatParam,
                      label="Attenuate undershooting (K)",
                      expertLevel=LEVEL_ADVANCED, default=9,
                      help="Values below avg-K*sigma are attenuated")
        form.addParam('postDifference', BooleanParam,
                      label="Evaluate difference", expertLevel=LEVEL_ADVANCED,
                      default=True)
    ...
    def createOutput(self):
        ...
        Ts = self.readInfoField(fnLastDir, "sampling",
        ...
        if exists(fnLastAngles):
            ...
            self.runJob('xmipp_metadata_utilities',
                        '-i %s -o %s --operate modify_values "image=image1"' % (
                            fnLastAngles, fnAngles), numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --operate sort particleId' % fnAngles,
                        numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --operate drop_column image1' % fnAngles,
                        numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --operate modify_values "itemId=particleId"' % fnAngles,
                        numberOfMpi=1)
    ...
    def _createItemMatrix(self, particle, row):
        if row.containsLabel(xmippLib.MDL_CONTINUOUS_X):
            row.setValue(xmippLib.MDL_SHIFT_X,
                         row.getValue(xmippLib.MDL_CONTINUOUS_X))
            row.setValue(xmippLib.MDL_SHIFT_Y,
                         row.getValue(xmippLib.MDL_CONTINUOUS_Y))
            row.setValue(xmippLib.MDL_FLIP,
                         row.getValue(xmippLib.MDL_CONTINUOUS_FLIP))
        row.setValue(xmippLib.MDL_SHIFT_X,
        ...
        setXmippAttributes(particle, row, xmippLib.MDL_SHIFT_X,
                           xmippLib.MDL_SHIFT_Y, xmippLib.MDL_ANGLE_TILT,
                           xmippLib.MDL_SCALE, xmippLib.MDL_MAXCC,
                           xmippLib.MDL_MAXCC_PERCENTILE, xmippLib.MDL_WEIGHT)
        if row.containsLabel(xmippLib.MDL_ANGLE_DIFF0):
            setXmippAttributes(particle, row, xmippLib.MDL_ANGLE_DIFF0,
                               xmippLib.MDL_WEIGHT_JUMPER0)
        if row.containsLabel(xmippLib.MDL_CONTINUOUS_X):
            ...
            if row.containsLabel(xmippLib.MDL_CONTINUOUS_GRAY_A):
                setXmippAttributes(xmippLib.MDL_CONTINUOUS_GRAY_A,
                                   xmippLib.MDL_CONTINUOUS_GRAY_B)
        ...
        if row.containsLabel(xmippLib.MDL_ANGLE_DIFF):
            setXmippAttributes(particle, row, xmippLib.MDL_ANGLE_DIFF)
        if row.containsLabel(xmippLib.MDL_ANGLE_DIFF2):
            setXmippAttributes(particle, row, xmippLib.MDL_ANGLE_DIFF2)
        if row.containsLabel(xmippLib.MDL_ANGLE_TEMPERATURE):
    ...
    def copyBasicInformation(self):
        ...
        if not self.inputParticles.hasValue():
            copyFile(previousRun._getExtraPath('images.xmd'),
                     self._getExtraPath('images.xmd'))
            copyFile(previousRun._getExtraPath('imagesId.xmd'),
                     self._getExtraPath('imagesId.xmd'))
        if previousRun.weightSSNR:
            copyFile(previousRun._getExtraPath('ssnrWeights.xmd'),
                     self._getExtraPath('ssnrWeights.xmd'))
        elif self.weightSSNR:
            self.doWeightSSNR()

        lastIter = self.getNumberOfPreviousIterations()
        for i in range(0, lastIter + 1):
            createLink(previousRun._getExtraPath("Iter%03d" % i),
    ...
    def doIteration000(self):
        ...
        if self.splitMethod == self.SPLIT_FIXED:
            self.runJob("xmipp_metadata_split",
                        "-i %s --oroot %s/images -n 2" % (
                            self.imgsFn, fnDirCurrent), numberOfMpi=1)
            for i in range(1, 3):
                moveFile("%s/images%06d.xmd" % (fnDirCurrent, i),
        ...
        if isinstance(self.inputVolumes.get(), SetOfVolumes):
            ...
            if self.inputVolumes.get() is None:
                self.runJob('xmipp_reconstruct_fourier',
                            "-i %s -o %s --max_resolution 0.3 --sampling %f --sym %s" % \
                            (self.imgsFn, fnVol1, TsCurrent,
        ...
        self.runJob('xmipp_transform_randomize_phases',
                    "-i %s -o %s --freq discrete %f" % (
                    fnVol1, fnVol2, maxFreq), numberOfMpi=1)
    ...
    def evaluateReconstructions(self, iteration):
        ...
        fnMask = ""
        volXdim = self.readInfoField(fnDirCurrent, "size", xmippLib.MDL_XSIZE)
        if self.postAdHocMask.hasValue():
            fnMask = join(fnDirCurrent, "mask.vol")
            if not exists(fnMask):
                self.prepareMask(self.postAdHocMask.get(), fnMask, TsCurrent,
                                 volXdim)
            self.runJob("xmipp_image_operate",
                        "-i %s --mult %s" % (fnVolFSC1, fnMask), numberOfMpi=1)
            self.runJob("xmipp_image_operate",
                        "-i %s --mult %s" % (fnVolFSC2, fnMask), numberOfMpi=1)

        # Threshold
        self.runJob('xmipp_transform_threshold',
                    '-i %s --select below 0 --substitute value 0 ' % fnVolFSC1,
                    numberOfMpi=1)
        self.runJob('xmipp_transform_threshold',
                    '-i %s --select below 0 --substitute value 0 ' % fnVolFSC2,
                    numberOfMpi=1)
        ...
        fnBeforeVol1 = join(fnDirCurrent,
                            "volumeBeforePostProcessing%02d.vol" % 1)
        fnBeforeVol2 = join(fnDirCurrent,
                            "volumeBeforePostProcessing%02d.vol" % 2)
        if exists(fnBeforeVol1) and exists(fnBeforeVol2):
            fnBeforeFsc = join(fnDirCurrent, "fscBeforePostProcessing.xmd")
            self.runJob('xmipp_resolution_fsc',
                        '--ref %s -i %s -o %s --sampling_rate %f' % (
                            fnBeforeVol1, fnBeforeVol2, fnBeforeFsc, TsCurrent),
                        numberOfMpi=1)
        mdFSC = xmippLib.MetaData(fnFsc)
        resolution = 2 * TsCurrent
        for objId in mdFSC:
            fsc = mdFSC.getValue(xmippLib.MDL_RESOLUTION_FRC, objId)
        ...
        if iteration > 0:
            self.runJob('xmipp_transform_filter',
                        '-i %s -o %s --fourier low_pass %f --sampling %f' % \
                        (join(fnDirCurrent, "volumeAvg.mrc"),
                         join(fnDirCurrent, "volumeAvgFiltered.mrc"),
                         resolution, TsCurrent), numberOfMpi=1)

        # A little bit of statistics (accepted and rejected particles, number of directions, ...)
        if iteration > 0:
            from xmippLib import AGGR_MAX
            for i in range(1, 3):
                fnAnglesi = join(fnDirCurrent, "angles%02d.xmd" % i)
                mdAngles = xmippLib.MetaData(fnAnglesi)
                mdUnique = xmippLib.MetaData()
                mdUnique.aggregateMdGroupBy(mdAngles, AGGR_MAX,
                                            [xmippLib.MDL_PARTICLE_ID],
                                            xmippLib.MDL_WEIGHT,
                                            xmippLib.MDL_WEIGHT)
                mdUnique.sort(xmippLib.MDL_PARTICLE_ID)
            ...
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --set union_all %s -o %s" % (
                            fnUsed1, fnUsed2, fnUsed), numberOfMpi=1)
            cleanPath(fnUsed1)
            cleanPath(fnUsed2)
            ...
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --operate keep_column particleId -o %s" % (
                            fnUsed, fnUsedId), numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --set natural_join %s" % (fnUsedId, fnAngles),
                        numberOfMpi=1)
            ...
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --set subtraction %s particleId -o %s" % (
                            fnImagesId, fnUsedId, fnImagesRejected),
                        numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --set natural_join %s" % (
                            fnImagesRejected, fnImages), numberOfMpi=1)
            cleanPath(fnUsedId)
    ...
    def checkInfoField(self, fnDir, block):
        ...
        if not exists(fnInfo):
            return False
        blocks = xmippLib.getBlocksInMetaDataFile(fnInfo)
    ...
    def prepareImages(self, fnDirPrevious, fnDir, TsCurrent, getShiftsFrom=''):
        if self.checkInfoField(fnDir, "count"):
            state = self.readInfoField(fnDir, "count", xmippLib.MDL_COUNT)
            if state >= 1:
                return
        ...
        if self.splitMethod == self.SPLIT_STOCHASTIC:
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --set intersection %s particleId particleId -o %s/all_images.xmd' % \
                        (fnSource, self._getExtraPath('images.xmd'), fnDir),
                        numberOfMpi=1)
            self.runJob("xmipp_metadata_split",
                        "-i %s/all_images.xmd --oroot %s/images -n 2" % (
                            fnDir, fnDir), numberOfMpi=1)
            cleanPath("%s/all_images.xmd" % fnDir)
            for i in range(1, 3):
                moveFile("%s/images%06d.xmd" % (fnDir, i),
                         "%s/images%02d.xmd" % (fnDir, i))
        else:
            for i in range(1, 3):
                fnImagesi = join(fnDir, "images%02d.xmd" % i)
                self.runJob('xmipp_metadata_utilities',
                            '-i %s --set intersection %s/images%02d.xmd particleId particleId -o %s' % \
        ...
        if self.alignmentMethod == self.STOCHASTIC_ALIGNMENT:
            for i in range(1, 3):
                fnImagesi = join(fnDir, "images%02d.xmd" % i)
                self.runJob('xmipp_metadata_utilities',
                            '-i %s --operate random_subset %d' % \
                            (fnImagesi, self.NimgsSGD), numberOfMpi=1)

        if getShiftsFrom != "":
            fnPreviousAngles = join(getShiftsFrom, "angles.xmd")
            TsPrevious = self.readInfoField(getShiftsFrom, "sampling",
                                            xmippLib.MDL_SAMPLINGRATE)
            fnAux = join(fnDir, "aux.xmd")
            for i in range(1, 3):
                fnImagesi = join(fnDir, "images%02d.xmd" % i)
                self.runJob('xmipp_metadata_utilities',
                            '-i %s --set join %s particleId particleId -o %s' % \
    ...
    def prepareReferences(self, fnDirPrevious, fnDir, TsCurrent,
                          targetResolution):
        if self.checkInfoField(fnDir, "count"):
            state = self.readInfoField(fnDir, "count", xmippLib.MDL_COUNT)
            if state >= 2:
        ...
        oldXdim = self.readInfoField(fnDirPrevious, "size", xmippLib.MDL_XSIZE)
        for i in range(1, 3):
            ...
            if oldXdim != newXdim:
                self.runJob("xmipp_image_resize", "-i %s -o %s --dim %d" % (
                    fnPreviousVol, fnReferenceVol, newXdim), numberOfMpi=1)
            else:
                copyFile(fnPreviousVol, fnReferenceVol)
            self.runJob('xmipp_transform_filter',
                        '-i %s --fourier fsc %s --sampling %f' % (
                            fnReferenceVol, join(fnDirPrevious, "fsc.xmd"),
                ...
                if self.postSymmetryHelical:
                    ...
                    if R <= 0:
                        R = self.inputParticles.get().getDimensions()[
                                0] / 2 * self.TsOrig
                    self.runJob('xmipp_transform_mask',
                                '-i %s --mask cylinder -%d -%d' % \
                                (fnReferenceVol, round(R / TsCurrent), newXdim),
                                numberOfMpi=1)
                else:
                    R = self.particleRadius.get()
                    if R <= 0:
            ...
            if self.nextDropout.get() > 0.0:
                self.runJob('xmipp_image_operate', '-i %s --dropout %f' % (
                    fnReferenceVol, self.nextDropout), numberOfMpi=1)
    ...
    def prepareMask(self, maskObject, fnMask, TsMaskOut, XdimOut):
        ...
        self.runJob('xmipp_image_resize', "-i %s --factor %f" % (
            fnMask, maskObject.getSamplingRate() / TsMaskOut), numberOfMpi=1)
        maskXdim, _, _, _ = img.getDimensions((1, fnMask))
        if XdimOut != maskXdim:
            self.runJob('xmipp_transform_window',
                        "-i %s --size %d" % (fnMask, XdimOut), numberOfMpi=1)
    ...
    def globalAssignment(self, iteration):
        ...
        if self.alignmentMethod == self.GLOBAL_ALIGNMENT or self.alignmentMethod == self.AUTOMATIC_ALIGNMENT or \
            ...
            targetResolution = max(previousResolution * 0.5,
                                   self._maximumTargetResolution[iteration - 1])
            ...
            self.prepareImages(fnDirPrevious, fnGlobal, TsCurrent,
                               getShiftsFrom)
            self.prepareReferences(fnDirPrevious, fnGlobal, TsCurrent,
                                   targetResolution)
            ...
            newXdim = self.readInfoField(fnGlobal, "size", xmippLib.MDL_XSIZE)
            angleStep = self.calculateAngStep(newXdim, TsCurrent,
                                              ResolutionAlignment)
            angleStep = max(angleStep, 3.0)
            self.writeInfoField(fnGlobal, "angleStep", xmippLib.MDL_ANGLE_DIFF,
                                float(angleStep))

            # Global alignment
            perturbationList = [chr(x) for x in range(ord('a'), ord(
                'a') + self.numberOfPerturbations.get())]
            for i in range(1, 3):
                ...
                if row.containsLabel(
                        xmippLib.MDL_CTF_MODEL) or row.containsLabel(
                ...
                for subset in perturbationList:
                    fnGallery = join(fnDirSignificant,
                                     "gallery%02d%s.stk" % (i, subset))
                    fnGalleryMd = join(fnDirSignificant,
                                       "gallery%02d%s.xmd" % (i, subset))
                    ...
                    args = "-i %s -o %s --sampling_rate %f --sym %s --min_tilt_angle %f --max_tilt_angle %f --perturb %f " % \
                           (fnReferenceVol, fnGallery, angleStep,
                            self.symmetryGroup, self.angularMinTilt.get(),
                            self.angularMaxTilt.get(),
                    ...
                    moveFile(join(fnDirSignificant,
                                  "gallery%02d%s.doc" % (i, subset)),
                             fnGalleryMd)
                    fnAngles = join(fnGlobal,
                                    "anglesDisc%02d%s.xmd" % (i, subset))
                    for j in range(1, numberGroups + 1):
                        fnAnglesGroup = join(fnDirSignificant,
                                             "angles_group%03d%s.xmd" % (
                                                 j, subset))
                        if not exists(fnAnglesGroup):
                            if ctfPresent:
                                fnGroup = "ctfGroup%06d@%s/ctf_groups.xmd" % (
                                    j, fnDirSignificant)
                                fnCTF = "%d@%s/ctf_ctf.stk" % (
                                    j, fnDirSignificant)
                                fnGalleryGroup = fnGallery = join(
                                    fnDirSignificant,
                                    "gallery%02d%s_%06d.stk" % (i, subset, j))
                                fnGalleryGroupMd = fnGallery = join(
                                    fnDirSignificant,
                                    "gallery%02d%s_%06d.xmd" % (i, subset, j))
                                self.runJob("xmipp_transform_filter",
                                            "-i %s -o %s --fourier binary_file %s --save_metadata_stack %s --keep_input_columns" % \
                                            (fnGalleryMd, fnGalleryGroup, fnCTF,
                                             fnGalleryGroupMd),
                                            numberOfMpi=min(
                                                self.numberOfMpi.get(), 24))
                            else:
                                fnGroup = fnImgs
                            ...
                            if exists(fnAnglesGroup):
                                if not exists(fnAngles) and exists(
                                        fnAnglesGroup):
                                    copyFile(fnAnglesGroup, fnAngles)
                                else:
                                    if exists(fnAngles) and exists(
                                            fnAnglesGroup):
                                        self.runJob("xmipp_metadata_utilities",
                                                    "-i %s --set union_all %s" % (
                                                        fnAngles,
                    ...
                    if exists(fnAngles) and exists(fnImgs):
                        self.runJob("xmipp_metadata_utilities",
                                    "-i %s --set join %s image" % (
                                        fnAngles, fnImgs), numberOfMpi=1)
                    if self.saveSpace and ctfPresent:
                        self.runJob("rm -f", fnDirSignificant + "/gallery*",
                                    numberOfMpi=1)
                ...
                for subset1 in perturbationList:
                    ...
                    for subset2 in perturbationList:
                        if subset1 == subset2:
                            continue
                        fnAngles2 = join(fnGlobal,
                                         "anglesDisc%02d%s.xmd" % (i, subset2))
                        fnOut12 = join(fnGlobal, "anglesDisc%02d%s%s" % (
                            i, subset1, subset2))
                        self.runJob("xmipp_angular_distance",
                                    "--ang1 %s --ang2 %s --oroot %s --sym %s --compute_weights 1 particleId 0.5 --check_mirrors --set 0" % (
                                        fnAngles2, fnAngles1, fnOut12,
                                        self.symmetryGroup), numberOfMpi=1)
                        self.runJob("xmipp_metadata_utilities",
                                    '-i %s --operate keep_column "angleDiff0 shiftDiff0 weightJumper0"' % (
                                            fnOut12 + "_weights.xmd"),
                                    numberOfMpi=1)
                        if counter2 == 0:
                            mdWeightsAll = xmippLib.MetaData(
                                fnOut12 + "_weights.xmd")
                            counter2 = 1
                        else:
                            mdWeights = xmippLib.MetaData(
                                fnOut12 + "_weights.xmd")
                            if mdWeights.size() == mdWeightsAll.size():
                                counter2 += 1
                                for id1, id2 in izip(mdWeights, mdWeightsAll):
                                    angleDiff0 = mdWeights.getValue(
                                        xmippLib.MDL_ANGLE_DIFF0, id1)
                                    shiftDiff0 = mdWeights.getValue(
                                        xmippLib.MDL_SHIFT_DIFF0, id1)
                                    weightJumper0 = mdWeights.getValue(
                                        xmippLib.MDL_WEIGHT_JUMPER0, id1)

                                    angleDiff0All = mdWeightsAll.getValue(
                                        xmippLib.MDL_ANGLE_DIFF0, id2)
                                    shiftDiff0All = mdWeightsAll.getValue(
                                        xmippLib.MDL_SHIFT_DIFF0, id2)
                                    weightJumper0All = mdWeightsAll.getValue(
                                        xmippLib.MDL_WEIGHT_JUMPER0, id2)

                                    mdWeightsAll.setValue(
                                        xmippLib.MDL_ANGLE_DIFF0,
                                        angleDiff0 + angleDiff0All, id2)
                                    mdWeightsAll.setValue(
                                        xmippLib.MDL_SHIFT_DIFF0,
                                        shiftDiff0 + shiftDiff0All, id2)
                                    mdWeightsAll.setValue(
                                        xmippLib.MDL_WEIGHT_JUMPER0,
                                        weightJumper0 + weightJumper0All, id2)
                    if counter2 > 1:
                        iCounter2 = 1.0 / counter2
                        for id in mdWeightsAll:
                            angleDiff0All = mdWeightsAll.getValue(
                                xmippLib.MDL_ANGLE_DIFF0, id)
                            shiftDiff0All = mdWeightsAll.getValue(
                                xmippLib.MDL_SHIFT_DIFF0, id)
                            weightJumper0All = mdWeightsAll.getValue(
                                xmippLib.MDL_WEIGHT_JUMPER0, id)

                            mdWeightsAll.setValue(xmippLib.MDL_ANGLE_DIFF0,
                                                  angleDiff0All * iCounter2, id)
                            mdWeightsAll.setValue(xmippLib.MDL_SHIFT_DIFF0,
                                                  shiftDiff0All * iCounter2, id)
                            mdWeightsAll.setValue(xmippLib.MDL_WEIGHT_JUMPER0,
                                                  weightJumper0All * iCounter2,
                                                  id)
                    if counter2 > 0:
                        mdWeightsAll.write(fnOut1 + "_weights.xmd")
                        self.runJob("xmipp_metadata_utilities",
                                    '-i %s --set merge %s' % (
                                        fnAngles1, fnOut1 + "_weights.xmd"),
                                    numberOfMpi=1)
    ...
    def adaptShifts(self, fnSource, TsSource, fnDest, TsDest):
        ...
        if row.containsLabel(xmippLib.MDL_SHIFT_X):
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --operate modify_values "shiftX=%f*shiftX"' % (
                            fnDest, K), numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --operate modify_values "shiftY=%f*shiftY"' % (
                            fnDest, K), numberOfMpi=1)
        if row.containsLabel(xmippLib.MDL_CONTINUOUS_X):
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --operate modify_values "continuousX=%f*continuousX"' % (
                            fnDest, K), numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        '-i %s --operate modify_values "continuousY=%f*continuousY"' % (
                            fnDest, K), numberOfMpi=1)
    ...
    def localAssignment(self, iteration):
        ...
        if self.alignmentMethod == self.LOCAL_ALIGNMENT or \
            ...
            previousResolution = self.readInfoField(fnDirPrevious, "resolution",
                                                    xmippLib.MDL_RESOLUTION_FREQREAL)
            targetResolution = max(previousResolution * 0.8,
                                   self._maximumTargetResolution[iteration - 1])
            if self.multiresolution:
                TsCurrent = max(self.TsOrig, targetResolution / 3)
            else:
                TsCurrent = self.TsOrig
            self.writeInfoField(fnDirLocal, "sampling",
                                xmippLib.MDL_SAMPLINGRATE, TsCurrent)
            TsCurrent = self.readInfoField(fnDirLocal, "sampling",
                                           xmippLib.MDL_SAMPLINGRATE)  # Write and read to guarantee consistency with previous directories
            ...
            if exists(fnDirGlobal):
                TsGlobal = self.readInfoField(fnDirGlobal, "sampling",
                                              xmippLib.MDL_SAMPLINGRATE)
            ...
            if produceNewReferences:
                self.prepareImages(fnDirPrevious, fnDirLocal, TsCurrent,
                                   fnDirPrevious)
                self.prepareReferences(fnDirPrevious, fnDirLocal, TsCurrent,
                                       targetResolution)
            else:
                newXdim = self.readInfoField(fnDirGlobal, "size",
                                             xmippLib.MDL_XSIZE)
                self.writeInfoField(fnDirLocal, "size", xmippLib.MDL_XSIZE,
                                    newXdim)
                for i in range(1, 3):
                    createLink(join(fnDirGlobal, "images%02d.xmd" % i),
                               join(fnDirLocal, "images%02d.xmd" % i))
                    createLink(join(fnDirGlobal, "volumeRef%02d.vol" % i),
                               join(fnDirLocal, "volumeRef%02d.vol" % i))

            # Compute maximum angular deviation
            ResolutionAlignment = previousResolution
            if self.nextLowPass:
                ResolutionAlignment += self.nextResolutionOffset.get()
            newXdim = self.readInfoField(fnDirLocal, "size", xmippLib.MDL_XSIZE)
            maxAngle = 3 * self.calculateAngStep(newXdim, TsCurrent,
                                                 ResolutionAlignment)

            for i in range(1, 3):
                state = self.readInfoField(fnDirLocal, "count",
                                           xmippLib.MDL_COUNT)
                if state >= 2 + i:
                    continue
                ...
                if exists(fnDirGlobal):
                    fnGlobalAssignment = join(fnDirGlobal,
                                              "anglesDisc%02d.xmd" % i)
                    TsGlobal = self.readInfoField(fnDirGlobal, "sampling",
                                                  xmippLib.MDL_SAMPLINGRATE)
                    if TsGlobal == TsCurrent:
                        copyFile(fnGlobalAssignment, fnLocalAssignment)
                    else:
                        self.adaptShifts(fnGlobalAssignment, TsGlobal,
                                         fnLocalAssignment, TsCurrent)
                else:
                    TsPrevious = self.readInfoField(fnDirPrevious, "sampling",
                                                    xmippLib.MDL_SAMPLINGRATE)
                    fnAux = join(fnDirLocal, "aux.xmd")
                    self.runJob("xmipp_metadata_utilities",
                                "-i %s --set intersection %s particleId particleId -o %s" % \
                                (join(fnDirPrevious, "angles.xmd"),
                                 fnLocalImages, fnAux), numberOfMpi=1)
                    self.adaptShifts(fnAux, TsPrevious, fnLocalAssignment,
                                     TsCurrent)
                    cleanPath(fnAux)
                self.runJob("xmipp_metadata_utilities",
                            "-i %s --operate drop_column image" % fnLocalAssignment,
                            numberOfMpi=1)
                self.runJob("xmipp_metadata_utilities",
                            '-i %s --operate keep_column "particleId image" -o %s' % (
                                fnLocalImages, fnLocalImagesIdx), numberOfMpi=1)
                self.runJob("xmipp_metadata_utilities",
                            '-i %s --operate remove_duplicates particleId' % (
                                fnLocalImagesIdx), numberOfMpi=1)
                self.runJob("xmipp_metadata_utilities",
                            "-i %s --set join %s particleId" % (
                                fnLocalAssignment, fnLocalImagesIdx),
                            numberOfMpi=1)
                ...
                args = "-i %s -o %s --sampling %f --Rmax %d --padding %d --ref %s --max_resolution %f --applyTo image1 --Nsimultaneous %d" % \
                       (fnLocalAssignment, fnLocalStk, TsCurrent, R,
                        self.contPadding.get(), fnVol, previousResolution,
                        self.contSimultaneous.get())
                if self.contShift or self.alignmentMethod.get() == self.AUTOMATIC_ALIGNMENT:
                    args += " --optimizeShift --max_shift %f" % (
                            self.contMaxShiftVariation.get() * newXdim * 0.01)
                if self.contScale or (
                ...
                self.runJob("xmipp_angular_continuous_assign2", args,
                            numberOfMpi=self.numberOfMpi.get())
                self.runJob("xmipp_transform_mask",
                            "-i %s --mask circular -%d" % (fnLocalStk, R),
                            numberOfMpi=min(self.numberOfMpi.get(), 24))
                self.writeInfoField(fnDirLocal, "count", xmippLib.MDL_COUNT,
                                    long(2 + i))
    ...
    def weightParticles(self, iteration):
        ...
        for i in range(1, 3):
            ...
            if exists(fnAnglesCont):
                ...
                TsCurrent = self.readInfoField(fnDirLocal, "sampling",
                                               xmippLib.MDL_SAMPLINGRATE)
                Xdim = self.readInfoField(fnDirLocal, "size",
                                          xmippLib.MDL_XSIZE)
            else:
                if exists(fnAnglesDisc):
                    ...
                    TsCurrent = self.readInfoField(fnDirGlobal, "sampling",
                                                   xmippLib.MDL_SAMPLINGRATE)
                    Xdim = self.readInfoField(fnDirGlobal, "size",
                                              xmippLib.MDL_XSIZE)
                else:
                    raise Exception(
                        "Angles for iteration " + str(iteration) + " not found")
            self.writeInfoField(fnDirCurrent, "sampling",
                                xmippLib.MDL_SAMPLINGRATE, TsCurrent)
            self.writeInfoField(fnDirCurrent, "size", xmippLib.MDL_XSIZE, Xdim)

            if self.weightSSNR:
                row = getFirstRow(fnAngles)
                if row.containsLabel(xmippLib.MDL_WEIGHT_SSNR):
                    self.runJob("xmipp_metadata_utilities",
                                "-i %s --operate drop_column weightSSNR" % fnAngles,
                                numberOfMpi=1)
                self.runJob("xmipp_metadata_utilities",
                            "-i %s --set join %s particleId" % \
                            (fnAngles, self._getExtraPath("ssnrWeights.xmd")),
                            numberOfMpi=1)
            if iteration > 1 and self.alignmentMethod != self.STOCHASTIC_ALIGNMENT:
                ...
                if self.splitMethod == self.SPLIT_FIXED:
                    ...
                    self.runJob("xmipp_metadata_utilities",
                                "-i %s --set intersection %s particleId particleId -o %s" % \
                                (join(fnDirPrevious, "angles.xmd"), fnAngles,
                                 fnPreviousAngles), numberOfMpi=1)
                self.runJob("xmipp_angular_distance",
                            "--ang1 %s --ang2 %s --compute_weights --check_mirrors --oroot %s --sym %s" % \
                            (fnPreviousAngles, fnAngles,
                             fnDirCurrent + "/jumper", self.symmetryGroup),
                            numberOfMpi=1)
                moveFile(fnDirCurrent + "/jumper_weights.xmd", fnAngles)
                if self.splitMethod == self.SPLIT_STOCHASTIC:
                    cleanPath(fnPreviousAngles)
                if iteration > 2:
                    fnDirPrevious = self._getExtraPath(
                        "Iter%03d" % (iteration - 2))
                    if self.splitMethod == self.SPLIT_FIXED:
                        fnPreviousAngles = join(fnDirPrevious,
                                                "angles%02d.xmd" % i)
                    else:
                        fnPreviousAngles = join(fnDirCurrent, "aux.xmd")
                        self.runJob("xmipp_metadata_utilities",
                    ...
                    self.runJob("xmipp_angular_distance",
                                "--ang1 %s --ang2 %s --compute_weights --check_mirrors --oroot %s --set 2 --sym %s" % \
                                (fnPreviousAngles, fnAngles,
                                 fnDirCurrent + "/jumper", self.symmetryGroup),
                                numberOfMpi=1)
                    moveFile(fnDirCurrent + "/jumper_weights.xmd", fnAngles)
            ...
            for objId in mdAngles:
                ...
                if self.weightJumper and self.alignmentMethod == self.GLOBAL_ALIGNMENT and self.numberOfPerturbations.get() > 1:
                    aux = mdAngles.getValue(xmippLib.MDL_WEIGHT_JUMPER0, objId)
                    weight *= aux
                if self.weightSSNR:
                    aux = mdAngles.getValue(xmippLib.MDL_WEIGHT_SSNR, objId)
                    weight *= aux
                if self.weightContinuous and exists(
                        fnAnglesCont) and self.alignmentMethod == self.LOCAL_ALIGNMENT:
                    aux = mdAngles.getValue(xmippLib.MDL_WEIGHT_CONTINUOUS2,
                                            objId)
                    weight *= aux
                # if self.weightResiduals and exists(fnAnglesCont):
                #    aux=mdAngles.getValue(xmippLib.MDL_ZSCORE_RESCOV,objId)
                #    aux/=3
                #    weight*=exp(-0.5*aux*aux)
                #    aux=mdAngles.getValue(xmippLib.MDL_ZSCORE_RESMEAN,objId)
                #    aux/=3
                #    weight*=exp(-0.5*aux*aux)
                #    aux=mdAngles.getValue(xmippLib.MDL_ZSCORE_RESVAR,objId)
                #    aux/=3
                #    weight*=exp(-0.5*aux*aux)
                if self.weightJumper and iteration > 1:
                    w1 = mdAngles.getValue(xmippLib.MDL_WEIGHT_JUMPER, objId)
                    w2 = 1.0
                    if iteration > 2:
                        w2 = mdAngles.getValue(xmippLib.MDL_WEIGHT_JUMPER2,
                                               objId)
                    weight *= w1 * w2

                mdAngles.setValue(xmippLib.MDL_WEIGHT, weight, objId)
        ...
        self.runJob('xmipp_metadata_utilities', "-i %s --set union %s -o %s" % (
            fnAngles1, fnAngles2, fnAngles), numberOfMpi=1)
    ...
    def qualifyParticles(self, iteration):
        ...
        if self.weightCC:
            ...
            for objId in mdAngles:
                if self.alignmentMethod == self.LOCAL_ALIGNMENT:
                    w = mdAngles.getValue(xmippLib.MDL_COST_PERCENTILE, objId)
                else:
                    w = mdAngles.getValue(xmippLib.MDL_MAXCC_PERCENTILE, objId)
                weight = mdAngles.getValue(xmippLib.MDL_WEIGHT, objId)
        ...
        if iteration == 1:
            self.runJob("xmipp_metadata_utilities",
                        "-i %s --fill angleTemp constant 0" % fnAngles,
                        numberOfMpi=1)
        else:
            fnAngles_1 = join(fnDirPrevious, "angles.xmd")
            fnTemp = join(fnDirCurrent, "previousAngleTemp.xmd")
            self.runJob("xmipp_metadata_utilities",
                        '-i %s --operate keep_column "particleId angleTemp" -o %s' % (
                            fnAngles_1, fnTemp), numberOfMpi=1)
            self.runJob("xmipp_metadata_utilities",
                        '-i %s --operate remove_duplicates particleId' % fnTemp,
                        numberOfMpi=1)
            self.runJob("xmipp_metadata_utilities",
                        '-i %s --set join %s particleId' % (fnAngles, fnTemp),
                        numberOfMpi=1)
            cleanPath(fnTemp)

        hasDiff0 = row.containsLabel(xmippLib.MDL_ANGLE_DIFF0)
        hasDiff1 = row.containsLabel(xmippLib.MDL_ANGLE_DIFF)
        hasDiff2 = row.containsLabel(xmippLib.MDL_ANGLE_DIFF2)
        if hasDiff0 or hasDiff1 or hasDiff2:
            ...
            for objId in mdAngles:
                perturbation = 0.
                if hasDiff0:
                    perturbation += mdAngles.getValue(xmippLib.MDL_ANGLE_DIFF0,
                                                      objId)
                if hasDiff1:
                    perturbation += mdAngles.getValue(xmippLib.MDL_ANGLE_DIFF,
                                                      objId)
                if hasDiff2:
                    perturbation += mdAngles.getValue(xmippLib.MDL_ANGLE_DIFF2,
                                                      objId)
                perturbation *= iNorm

                previousTemp = mdAngles.getValue(xmippLib.MDL_ANGLE_TEMPERATURE,
                                                 objId)
                currentTemp = (1 - K) * previousTemp + K * perturbation
                mdAngles.setValue(xmippLib.MDL_ANGLE_TEMPERATURE, currentTemp,
                                  objId)
            mdAngles.write(fnAngles)
    ...
    def reconstruct(self, iteration):
            ...
            if not exists(fnVol):
                ...
                if hasCTF:
                    ...
                    self.runJob("xmipp_ctf_correct_wiener2d", args,
                                numberOfMpi=min(self.numberOfMpi.get(), 24))
                    self.runJob("xmipp_image_eliminate_largeEnergy",
                                "-i %s.xmd --sigma2 9" % fnCorrectedImagesRoot,
                    ...
                    if self.alignmentMethod != self.STOCHASTIC_ALIGNMENT:
                        self.runJob('xmipp_metadata_utilities',
                                    '-i %s --set intersection %s particleId particleId' % (
                                        fnAngles, fnAnglesToUse), numberOfMpi=1)
                        # This is because eliminate_largeEnergy may have reduced the number of images in fnAngles

                if self.contGrayValues or (
                        self.alignmentMethod.get() == self.AUTOMATIC_ALIGNMENT and iteration >= 5):
                    grayAdjusted = True
                    R = self.particleRadius.get()
                    if R <= 0:
                    ...
                    fnRefVol = join(fnDirCurrent, "localAssignment",
                                    "volumeRef%02d.vol" % i)
                    fnDirPrevious = self._getExtraPath(
                        "Iter%03d" % (iteration - 1))
                    previousResolution = self.readInfoField(fnDirPrevious,
                                                            "resolution",
                                                            xmippLib.MDL_RESOLUTION_FREQREAL)
                    args = "-i %s -o %s.stk --sampling %f --Rmax %d --padding %d --ref %s --max_resolution %f --save_metadata_stack %s.xmd" % \
                           (fnAnglesToUse, fnGrayRoot, TsCurrent, R,
                            self.contPadding.get(), fnRefVol,
                            previousResolution, fnGrayRoot)
                    args += " --max_gray_scale %f --max_gray_shift %f --Nsimultaneous %d" % \
                            (self.contMaxGrayScale.get(),
                             self.contMaxGrayShift.get(),
                             self.contSimultaneous.get())
                    self.runJob("xmipp_transform_adjust_image_grey_levels",
                    ...
                    self.runJob("xmipp_metadata_utilities",
                                '-i %s --operate drop_column "continuousA continuousB"' % fnAngles,
                                numberOfMpi=1)
                    fnAux = join(fnDirCurrent,
                                 "gray_transformation%02d.xmd" % i)
                    self.runJob("xmipp_metadata_utilities",
                                '-i %s --operate keep_column "continuousA continuousB" -o %s' % (
                                    fnAnglesToUse, fnAux), numberOfMpi=1)
                    self.runJob("xmipp_metadata_utilities",
                                '-i %s --set merge %s' % (fnAngles, fnAux),
                                numberOfMpi=1)
                    cleanPath(fnAux)

                # Restrict the angles
                if self.restrictReconstructionAngles:
                    fnRestricted = join(fnDirCurrent,
                                        "images_restricted%02d.xmd" % i)
                    args = '-i %s --query select "angleRot > %f AND anglePsi < %f" -o %s' % \
                           (fnAnglesToUse, self.angularMinTiltReconstruct.get(),
                            self.angularMaxTiltReconstruct.get(), fnRestricted)
                ...
                if self.alignmentMethod == self.STOCHASTIC_ALIGNMENT:
                    newXdim = self.readInfoField(fnDirCurrent, "size",
                                                 xmippLib.MDL_XSIZE)
                    fnAuxVol = join(fnDirCurrent, "volume%02d_aux.vol" % i)
                    fnPreviousVol = join(fnDirPrevious, "volume%02d.vol" % i)
                    self.runJob("xmipp_image_resize", "-i %s -o %s --dim %d" % (
                        fnPreviousVol, fnAuxVol, newXdim))
                    self.runJob("xmipp_image_operate", "-i %s --mult %f" % (
                        fnVol, self.alphaSGD.get()))
                    self.runJob("xmipp_image_operate", "-i %s --mult %f" % (
                        fnAuxVol, 1 - self.alphaSGD.get()))
                    self.runJob("xmipp_image_operate",
                                "-i %s --plus %s" % (fnVol, fnAuxVol))
                    cleanPath(fnAuxVol)
                if deleteStack:
                    cleanPattern(deletePattern)
        ...
        if grayAdjusted:
            ...
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --set union %s -o %s" % (
                            fnAngles1, fnAngles2, fnAnglesAux), numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --operate keep_column itemId -o %s" % \
                        (fnAnglesAux, fnAnglesAuxId), numberOfMpi=1)
            self.runJob('xmipp_metadata_utilities',
                        "-i %s --set intersection %s itemId itemId" % \
                        (fnAngles, fnAnglesAuxId), numberOfMpi=1)
            self.runJob("xmipp_metadata_utilities",
                        '-i %s --operate sort itemId' % fnAngles, numberOfMpi=1)
            self.runJob("xmipp_metadata_utilities",
                        '-i %s --operate sort itemId' % fnAnglesAux,
                        numberOfMpi=1)
            self.runJob("xmipp_metadata_utilities",
                        '-i %s --operate keep_column "continuousA continuousB"' % fnAnglesAux,
                        numberOfMpi=1)
            self.runJob("xmipp_metadata_utilities",
                        '-i %s --set merge %s' % (fnAngles, fnAnglesAux),
                        numberOfMpi=1)
    ...
    def postProcessing(self, iteration):
        ...
        for i in range(1, 3):
            fnVol = join(fnDirCurrent, "volume%02d.vol" % i)
            fnBeforeVol = join(fnDirCurrent,
                               "volumeBeforePostProcessing%02d.vol" % i)
            volXdim = self.readInfoField(fnDirCurrent, "size",
                                         xmippLib.MDL_XSIZE)

            if self.postSymmetryWithinMask:
                if self.postMaskSymmetry != "c1":
                    fnMask = join(fnDirCurrent, "mask.vol")
                    self.prepareMask(self.postSymmetryWithinMaskMask.get(),
                                     fnMask, TsCurrent, volXdim)
                    self.runJob("xmipp_transform_symmetrize",
                                "-i %s --sym %s --mask_in %s --dont_wrap" % \
                                (fnVol, self.postSymmetryWithinMaskType.get(),
                                 fnMask), numberOfMpi=1)
                    cleanPath(fnMask)
            ...
            if self.postSymmetryHelical:
                ...
                height = int(volXdim)
                self.runCoarseSearch(fnVol, self.postSymmetryHelicalDihedral,
                                     0.9, z0, zF, zStep, rot0, rotF, rotStep, 1,
                                     fnCoarse, 0, radius, height, TsCurrent)
                self.runFineSearch(fnVol, self.postSymmetryHelicalDihedral,
                                   fnCoarse, fnFine, 0.9, z0, zF, rot0, rotF, 0,
                                   radius, height, TsCurrent)
                cleanPath(fnCoarse)
                self.runSymmetrize(fnVol, self.postSymmetryHelicalDihedral,
                                   fnFine, fnVol, 0.9, 0, radius, height,
                                   TsCurrent)
        ...
        if self.postSignificantDenoise:
            ...
            args = '--i1 %s --i2 %s --oroot %s --denoising 1' % (
                fnVol1, fnVol2, fnRootRestored)
            if fnMask != "":
        ...
        if self.postFilterBank:
            fnRootRestored = join(fnDirCurrent, "volumeRestored")
            args = '--i1 %s --i2 %s --oroot %s --filterBank 0.01' % (
                fnVol1, fnVol2, fnRootRestored)
            if fnMask != "":
                args += " --mask binary_file %s" % fnMask
            self.runJob('xmipp_volume_halves_restoration', args, numberOfMpi=1)
        ...
        if self.postDeconvolve:
            fnRootRestored = join(fnDirCurrent, "volumeRestored")
            args = '--i1 %s --i2 %s --oroot %s --deconvolution 1' % (
                fnVol1, fnVol2, fnRootRestored)
            if fnMask != "":
                args += " --mask binary_file %s" % fnMask
            self.runJob('xmipp_volume_halves_restoration', args, numberOfMpi=1)
        ...
        copyFile(fnVol,
                 fnForFSC)  # From this point, the two half volumes may be modified
        ...
        if self.postSoftNeg:
            ...
            if fnMask == "":
                fnMask = join(fnDirCurrent, "mask.vol")
                self.runJob("xmipp_transform_mask",
                            "-i %s --mask circular %d --create_mask %s" % (
                                fnVol1, -volXdim / 2, fnMask), numberOfMpi=1)
                removeMask = True
            ...
            self.runJob("xmipp_transform_filter",
                        "-i %s --softnegative %s %s %f %f" % (
                            fnVol1, fnMask, fnFsc, TsCurrent,
                            self.postSoftNegK),
                        numberOfMpi=1)
            self.runJob("xmipp_transform_filter",
                        "-i %s --softnegative %s %s %f %f" % (
                            fnVol2, fnMask, fnFsc, TsCurrent,
                            self.postSoftNegK),
                        numberOfMpi=1)
            cleanPath(fnFsc)
            if removeMask:
        ...
        if self.postDifference:
            fnRootRestored = join(fnDirCurrent, "volumeRestored")
            args = '--i1 %s --i2 %s --oroot %s --difference 2 2' % (
                fnVol1, fnVol2, fnRootRestored)
            if fnMask != "":
                args += " --mask binary_file %s" % fnMask
            self.runJob('xmipp_volume_halves_restoration', args, numberOfMpi=1)
    ...
    def cleanDirectory(self, iteration):
        ...
        if self.saveSpace:
            ...
            for i in range(1, 3):
                ...
                fnCorrectedImages = join(fnDirCurrent,
                                         "images_corrected%02d.stk" % i)
                if exists(
                        fnCorrectedImages) and iteration != self.firstIteration + self.numberOfIterations.get() - 1:
                    cleanPath(
                        fnCorrectedImages)  # Delete corrected images except for the last iteration
                    # if self.weightResiduals:
    ...
    def _validate(self):
        errors = []
        if isinstance(self.inputVolumes.get(),
                      SetOfVolumes) and self.inputVolumes.get().getSize() != 2:
            errors.append(
                "The set of input volumes should have exactly 2 volumes")
    ...
    def _warnings(self):
        ...
        if not self.doContinue and self.inputParticles.hasValue() and not self.inputParticles.get().isPhaseFlipped():
            warnings.append(
                "Highres is designed to work on phase flipped particles. The input particles are not phase flipped. "
    ...
    def _summary(self):
        ...
        if self.alignmentMethod == self.GLOBAL_ALIGNMENT:
            summary.append(
                "Global alignment, max shift=%f" % self.angularMaxShift.get())
        else:
        ...
        if hasattr(self, 'outputVolume') or True:
            ...
            if self.alignmentMethod == self.GLOBAL_ALIGNMENT:
                ...
                if self.contDefocus:
                    strline += "defocus"
            strline += ". "
            if self.weightSSNR or (
                    self.weightContinuous and self.alignmentMethod == self.LOCAL_ALIGNMENT) or self.weightJumper:
                ...
                strline += ". "
            if self.postAdHocMask.hasValue():
                strline += "We masked the reconstruction with %s. " % self.getObjectTag(
                    'postAdHocMask')
                if self.postSymmetryWithinMask:
                    strline += "We imposed %s symmetry within the mask %s. " % (
                        self.postSymmetryWithinMaskType.get(),
                        self.getObjectTag('postSymmetryWithinMaskMask'))
            if self.postSymmetryHelical:
